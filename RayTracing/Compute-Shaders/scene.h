...
World* createSceneFinalB2()
{
    ...
    // Base Sphere 1
    Sphere sphere = {};
    sphere.position = Vector3(4.5f, 2.0f, 2.0f);
    sphere.radius = 1.0f;
    sphere.materialIndex = 2;

    // Shiny Metal
    Sphere sphere2 = {};
    sphere2.position = Vector3(-1.5f, 1.0f, 0.0f);
    sphere2.radius = 1.0f;
    sphere2.materialIndex = 3;

    // Fuzzy Metal
    Sphere sphere3 = {};
    sphere3.position = Vector3(-4.0f, 2.0f, 2.0f);
    sphere3.radius = 1.0f;
    sphere3.materialIndex = 4;

    // Glass
    Sphere sphere4 = {};
    sphere4.position = Vector3(0.0f, 2.5f, 0.0f);
    sphere4.radius = 1.0f;
    sphere4.materialIndex = 5;
    ...
    // Shiny Metal 2
    Sphere sphere6 = {};
    sphere6.position = Vector3(4.0f, 3.0f, -4.0f);
    sphere6.radius = 2.0f;
    sphere6.materialIndex = 3;
    ...
    // Glass 2
    Sphere sphere8 = {};
    sphere8.position = Vector3(1.0f, 1.25f, 4.0f);
    sphere8.radius = 1.0f;
    sphere8.materialIndex = 5;
    ...
    Material defaultMaterial = {};
    //defaultMaterial.emitColor = Vector3(0.01f, 0.02f, 0.04f);
    ...
    // Fuzzy Metal
    Material sphere3Material = {};
    sphere3Material.color = Vector3(0.8f, 0.8f, 0.9f);
    sphere3Material.reflection = 0.87f;
    ...
    // Main Light
    Material sphere5Material = {};
    sphere5Material.emitColor = Vector3(20.0f, 15.0f, 12.0f) * 0.4f;
