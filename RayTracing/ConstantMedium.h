...
{
 public:
    ConstantMedium(std::shared_ptr<Hittable> b, double d, const std::shared_ptr<Texture>& a)
...
inline bool ConstantMedium::hit(const Ray& r, double t_min, double t_max, HitRecord& rec) const
{
